...
CREATE  VIEW vdocuments AS 
 ...
 s.saddr, s.saddr2, s.scode, s.ssri, s.sname, s.sruc, s.scedula, ci.descripda AS sciudad, s.spasaporte, j.sname AS vendedor, 
...
CREATE  VIEW varti AS 
 SELECT a.icode AS codigo, a.iname AS nombre, a.artpeso AS peso, a.artcosto AS costo, a.saldocon, a.isiva AS carga_iva, 
 	...
 	p.descripda as promocion, b.descripda as ubipro, e.descripda as ubica2, t.descripda as cntbulto
   FROM items a
   LEFT JOIN detagru u ON a.iunidad = u.iddato
   LEFT JOIN monedas m ON a.imoney = m.mocode
   LEFT JOIN detagru c ON a.artmarca = c.iddato
...
CREATE VIEW varticulos AS
    ...
    a.costopro, a.artsgrupo, b.descripda as ubipro, e.descripda as ubica2, t.descripda as cntbulto  
...
CREATE VIEW vplancta AS
	...
	p.idplancuenta, p.idcuenta, p.pdocode,
...
CREATE VIEW vdocub AS
    SELECT DISTINCT t.code, i.nucuban, i.ticuban, k.descripda AS banco, t.isanulado, t.idcuenta, t.nudocban, t.cbenef, 
...
CREATE  VIEW vdocui AS 
 SELECT t.code, i.iditem, i.icode, i.iname, i.marca, i.grupo, i.subgrupo, i.itag, i.genero, i.itipo, i.iname AS auxiliar, 
 	...
 	i.pvp, i.factorc, i.numeconver, i.denoconver, i.isiva as isivai, i.ubipro, i.ubica2 
   FROM detadoci t
